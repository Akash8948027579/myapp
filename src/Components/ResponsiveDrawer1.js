    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          <Box sx={{ width:{sm:'500px', xs:'370px'}, marginTop:'25px', marginLeft:{sm:'5px', xs:'200px'} }}>
          <TextField placeholder='search here' sx={{ width: '100%', background: 'white', height: '100%', marginTop: '0px' }} InputProps={{ sx: { height: '40px' } }} />
          <Box sx={{marginLeft: {sm:'450px', xs:'330px'}}}><img src={img25} alt='' style={{  marginTop: '-70px', position: 'relative', height: '20px', width: '20px' }} /></Box>
        </Box>
