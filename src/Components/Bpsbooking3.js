...
import ResponsiveDrawer3 from './ResponsiveDrawer3'

const Bpsbooking3 = () => {
  const theme = useTheme();
  return (
    //--------------------------------------------------- Main page------------------------------------------------------------------------ 
    <Grid sx={{ background: '#F3F2F7', width:{md:'100%', sm:'120%', xs:'300%'}}}>

      <ResponsiveDrawer3/>
      <Box sx={{ width: {sm:'1050px', xs:'300px'}, height: '40px', marginLeft: {sm:'270px', xs:'30px'}, marginTop: {sm:'-15px', xs:'-15px'}, display:{xs:'none', sm:'block'} }}>
        <Typography sx={{ color: '#464255', fontSize: 20, fontFamily: 'Inter', fontWeight: '600', marginTop: '5px' }}>Manage Booking</Typography>
        <Button sx={{[theme.breakpoints.up('xs')]: { width: '172px', height: '40px', borderRadius: '20px', background: '#0155A5', marginLeft: '600px', marginTop: '-48px'  }, 
